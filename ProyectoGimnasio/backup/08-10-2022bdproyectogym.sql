...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2022 a las 00:12:16
...
INSERT INTO `tbpagotipo` (`tbpagotipoid`, `tbpagotipotipo`) VALUES
(1, 'Efectivo'),
(2, 'Crédito'),
(3, 'Transferencia');
...
--
-- Estructura de tabla para la tabla `tbtarifa`
--

CREATE TABLE `tbtarifa` (
  `tbtarifa` int(11) NOT NULL,
  `tbpagotipoid` int(11) NOT NULL,
  `tbtarifamorosidad` int(11) NOT NULL,
  `tbtarifamorosidadalerta` int(11) NOT NULL,
  `tbtarifaperiodoid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbtarifaperiodo`
--

CREATE TABLE `tbtarifaperiodo` (
  `tbtarifaperiodoid` int(11) NOT NULL,
  `tbtarifaperiodotipo` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `tbtarifaperiodo`
--

INSERT INTO `tbtarifaperiodo` (`tbtarifaperiodoid`, `tbtarifaperiodotipo`) VALUES
(1, 'Diario'),
(2, 'Semanal'),
(3, 'Mensual'),
(4, 'Anual');
...
--
-- Indices de la tabla `tbtarifa`
--
ALTER TABLE `tbtarifa`
  ADD PRIMARY KEY (`tbtarifa`);

--
-- Indices de la tabla `tbtarifaperiodo`
--
ALTER TABLE `tbtarifaperiodo`
  ADD PRIMARY KEY (`tbtarifaperiodoid`);
...
--
ALTER TABLE `tbpagotipo`
  MODIFY `tbpagotipoid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `tbtarifa`
--
ALTER TABLE `tbtarifa`
  MODIFY `tbtarifa` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbtarifaperiodo`
--
ALTER TABLE `tbtarifaperiodo`
  MODIFY `tbtarifaperiodoid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
