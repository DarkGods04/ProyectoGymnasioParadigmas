...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2022 a las 09:59:28
...
(1, 'Zumba', 'Cardio haciendo zumba', 1),
(2, 'Spinning', 'Cardio haciendo spinning', 1),
(3, 'Boxeo', 'Clases de boxeo', 1),
(4, 'Taekwondo', 'Clases de taekwondo', 1);
...
CREATE TABLE `tbserviciotarifa` (
  ...
  `tbserviciotarifamonto` double NOT NULL,
...
INSERT INTO `tbserviciotarifa` (`tbserviciotarifaid`, `tbserviciotarifaservicioid`, `tbserviciotarifafechamodificacion`, `tbserviciotarifamonto`, `tbserviciotarifaactivo`) VALUES
(1, 1, '2022-10-09', 2500, 0),
(2, 2, '2022-10-09', 3000, 1),
(3, 3, '2022-10-09', 3500, 1),
(4, 1, '2022-10-09', 4000, 1),
(5, 4, '2022-10-09', 4400, 0),
(6, 4, '2022-10-09', 4500, 1);
